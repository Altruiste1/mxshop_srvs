...
type UserClient interface {
	...
	ChangePassword(ctx context.Context, in *PasswordChangeRequest, opts ...grpc.CallOption) (*PasswordChangeResponse, error)
}
...
func (c *userClient) ChangePassword(ctx context.Context, in *PasswordChangeRequest, opts ...grpc.CallOption) (*PasswordChangeResponse, error) {
...
type UserServer interface {
	...
	ChangePassword(context.Context, *PasswordChangeRequest) (*PasswordChangeResponse, error)
}
...
func (UnimplementedUserServer) ChangePassword(context.Context, *PasswordChangeRequest) (*PasswordChangeResponse, error) {
...
func _User_ChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).ChangePassword(ctx, req.(*PasswordChangeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
